<%@ Page Title="Istorija Zasedanja" Language="C#" MasterPageFile="~/SednicaAdmin.Master" AutoEventWireup="true" CodeBehind="IstorijaZasedanja.aspx.cs" Inherits="KorisnickiInterfejs.IstorijaZasedanja" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="search-section">
        ...
        <div class="search-row">
            ...
            <!-- Tip zasedanja filter je uklonjen - ne koristimo ga -->
            
            <!-- Datum filteri su uklonjeni - koristimo samo Saziv filter -->
    ...
    <div class="results-section">
        ...
        <div class="gridview-container">
            <asp:GridView ID="gvZasedanja" runat="server" 
                         CssClass="gridview" 
                         AutoGenerateColumns="False"
                         AllowPaging="True" 
                         PageSize="15"
                         OnPageIndexChanging="gvZasedanja_PageIndexChanging"
                         EmptyDataText="Nema podataka za prikaz"
                         EmptyDataRowStyle-CssClass="no-data">
                
                <Columns>
                    <asp:BoundField DataField="Naziv" HeaderText="Naziv Zasedanja" />
